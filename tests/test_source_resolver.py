...
def test_official_high_quality_wins_even_when_large_conflict_is_sent_to_review():
    resolved = resolve_best_value([
        SourceCandidate(100, "smartlab", "aggregator", quality_score=70, confidence_score=0.7, source_url="https://smart-lab.ru/q/TEST/f/y/"),
    ...
    assert resolved["best"].source_name == "official_ifrs_pdf_table"
    assert resolved["selected_reason"] == "official_ifrs_conflict_gt_5pct_needs_review"
