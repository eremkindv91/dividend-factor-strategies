...
DISCLAIMER = (
    ...
    "дивидендная доходность. Фундаментальные данные приведены с лагом. SHAP иллюстративен — по "
    "лучшей одиночной модели (xgboost), а не декомпозиция ансамблевого прогноза. Цены — MOEX ISS "
